...
public class ConfirmacionTopicPublisher extends Thread{
	private ArrayList<Tracker> trackers;
	private Tracker miTracker;
	
	String connectionFactoryName = "TopicConnectionFactory";
	//This name is defined in jndi.properties file
	String topicJNDIName = "jndi.ssdd.Confirmacion";		
	
	TopicConnection topicConnection = null;
	TopicSession topicSession = null;
	TopicPublisher topicPublisher = null;	
	
	public ConfirmacionTopicPublisher(ArrayList<Tracker> trackers, Tracker miTracker) {
		super();
	...
	public void run() {	
		...
		try {
			...
			objectMessage.setObject(new Confirmacion(miTracker.getId()));
